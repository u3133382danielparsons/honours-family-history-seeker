...
class LynMorris extends Component {
  state = {
    open: false
  };
      ...
      <div>
        <Paper style={style}>
          ...
          <Menu desktop={true} width={320}>
            <Subheader>Retired</Subheader>
            <Subheader>Aged 74</Subheader>
          ...
          >
            <List>
              <ListItem>You are now friends with Lyn Morris</ListItem>
              <ListItem>
                <Link to="/components/profile/profiles/LynMorrisProfile">
                  <RaisedButton
                    primary={true}
                    style={btnStyle}
                    label="Visit Lyn's Profile"
                    fullWidth={true}
                  />
                </Link>
              </ListItem>

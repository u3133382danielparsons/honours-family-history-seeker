...
import JohnSmithAv from '../../subscribers/members/img/download-1.png';
// inline styles
const styles = {
  drawer_container: {
...
class JohnSmithProfile extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          <BodyContainer openSecondary={false}>
            <ResponsiveAppBar
              ...
              iconElementRight={
                <FlatButton
                  href="https://github.com/u3133382danielparsons/honours-family-history-seeker/blob/master/src/containers/JohnSmithProfile.js"
                  target="_blank"
                  secondary={true}
                  icon={
            ...
            <div className="BackgroundGradient">
              <header>
                ...
                <Subheader style={styles.subheaderColor}>JOHN SMITH</Subheader>
              </header>
            </div>
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="JohnSmithfhseeker"
                      leftIcon={<Fingerprint />}
                    />
                    <ListItem
                      primaryText="Date of Birth"
                      secondaryText="20th June, 1993"
                      leftIcon={<DateRange />}
                    />
                    <ListItem
                    ...
                    <ListItem
                      ...
                      secondaryText="johnsmith@fmail.com"
                      leftIcon={<Email />}
                    />
                    <ListItem
                      primaryText="Phone Number"
                      secondaryText="1234 5678 910"
                      leftIcon={<Phone />}
                    />
                    <ListItem
                    ...
                    <ListItem
                      primaryText="Hobbies"
                      secondaryText="Music, Guitar, Reading, Badminton"
                      leftIcon={<Hobbies />}
                    />

                    <ListItem
                      primaryText="University"
                      secondaryText="Australian National University"
                      leftIcon={<University />}
                    />
                    <ListItem
                    ...
                    <ListItem
                      ...
                      secondaryText="anu3333@uni.canberra.edu.au"
                      leftIcon={<Email />}
                    />
                  </List>
                </CardText>
...
export default connect(mapStateToProps, mapDispatchToProps)(JohnSmithProfile);

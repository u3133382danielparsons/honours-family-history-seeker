...
class LynMorrisProfile extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          <BodyContainer openSecondary={false}>
            ...
            <div className="BackgroundGradient">
              <header>
                ...
                <Subheader style={styles.subheaderColor}>LYN MORRIS</Subheader>
              </header>
            </div>
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="LynMorrisfhseeker"
...
export default connect(mapStateToProps, mapDispatchToProps)(LynMorrisProfile);

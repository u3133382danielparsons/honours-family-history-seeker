...
import MaryJonesAv from '../../subscribers/members/img/ava-7.png';
// inline styles
const styles = {
  drawer_container: {
...
class SarahWaltersProfile extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          <BodyContainer openSecondary={false}>
            <ResponsiveAppBar
              ...
              iconElementRight={
                <FlatButton
                  href="https://github.com/u3133382danielparsons/honours-family-history-seeker/blob/master/src/containers/SarahWaltersProfile.js"
                  target="_blank"
                  secondary={true}
                  icon={
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="SarahWaltersfhseeker"
                      leftIcon={<Fingerprint />}
                    />
                    <ListItem
                      primaryText="Date of Birth"
                      secondaryText="20th November, 1990"
                      leftIcon={<DateRange />}
                    />
                    <ListItem
                    ...
                    <ListItem
                      ...
                      secondaryText="sarahwalters@gmail.com"
                      leftIcon={<Email />}
                    />
                    <ListItem
                      primaryText="Phone Number"
                      secondaryText="7777 777 777"
                      leftIcon={<Phone />}
                    />
                    <ListItem
                      primaryText="Occupation"
                      secondaryText="Public Servant"
                      leftIcon={<Work />}
                    />
                    <ListItem
                    ...
                    <ListItem
                      ...
                      secondaryText="Chinese, Geneology"
                      leftIcon={<Info />}
                    />
                    <ListItem
                      primaryText="Hobbies"
                      secondaryText="Walking, Dancing, Reading, Watching TV"
                      leftIcon={<Hobbies />}
                    />

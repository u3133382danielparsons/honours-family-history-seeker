...
import MaryJonesAv from '../../subscribers/members/img/ava.png';
// inline styles
const styles = {
  drawer_container: {
...
class JulieHughesProfile extends Component {
  render() {
    return (
      <div>
        <div>
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="JulieHughesfhseeker"
...
export default connect(mapStateToProps, mapDispatchToProps)(JulieHughesProfile);

...
import MaryJonesAv from '../../subscribers/members/img/ava-1.png';
// inline styles
const styles = {
  drawer_container: {
...
class MaryJonesProfile extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          <BodyContainer openSecondary={false}>
            ...
            <div className="BackgroundGradient">
              <header>
                ...
                <Subheader style={styles.subheaderColor}>MARY JONES</Subheader>
              </header>
            </div>
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="MaryJonesfhseeker"
...
export default connect(mapStateToProps, mapDispatchToProps)(MaryJonesProfile);

...
import MaryJonesAv from '../../subscribers/members/img/ava-4.png';
// inline styles
const styles = {
  drawer_container: {
...
class RosOsborneProfile extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          <BodyContainer openSecondary={false}>
            ...
            <div className="BackgroundGradient">
              <header>
                ...
                <Subheader style={styles.subheaderColor}>ROS OSBORNE</Subheader>
              </header>
            </div>
                ...
                <CardText>
                  <List>
                    <ListItem
                      ...
                      secondaryText="RosOsbornefhseeker"
...
export default connect(mapStateToProps, mapDispatchToProps)(RosOsborneProfile);
